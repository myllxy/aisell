...
public class PermissionController extends BaseController {
    ...
    @RequestMapping("/page")
    @ResponseBody
    public UIPage list(PermissionQuery query) {
    ...
    public Permission beforeUpdate(Long id, String _cmd) {
        /*
     ...
     * @param permission
     * @return
     * @link (" / permission / update ? _cmd = update ")
     */
