...
$(function () {
    ...
    let purchasebillitemForm = $("#purchasebillitemForm");
    ...
    itsource = {
        ...
        add() {
            ...
            purchasebillitemForm.form('clear');
        ...
        save() {
            ...
            if (purchasebillitemId) {
                url = "/purchasebillitem/update?_cmd=update";
            }
            // call 'submit' method of form plugin to submit the form
            purchasebillitemForm.form('submit', {
                url: url,
                onSubmit: function () {
                    // do some check
        ...
        update() {
            ...
            purchasebillitemForm.form('load', row);
            // 完成部门的回显
            purchasebillitemForm.form('reload');
        },
        delete() {
            //1.获取选中的行
            let row = datagrid.datagrid("getSelected");
