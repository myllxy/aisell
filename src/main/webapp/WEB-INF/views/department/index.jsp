...
<head>
    ...
    <%--引入当前模块对应的js--%>
    <script src="${pageContext.request.contextPath}/js/model/department.js"></script>
</head>
<body>
...
<table id="datagrid" class="easyui-datagrid"
       data-options="url:'/department/page',fitColumns:true,singleSelect:true,fit:true,pagination:true,toolbar:'#toolbar'">
    <thead>
    <tr>
