...
<head>
    ...
    <%--引入当前模块对应的js--%>
    <script src="${pageContext.request.contextPath}/js/model/supplier.js"></script>
</head>
<body>
<div id="toolbar" style="padding:5px;height:auto">
    ...
    <form action="/supplier/export" id="searchForm" method="post">
...
<table id="datagrid" class="easyui-datagrid"
       data-options="url:'/supplier/page',fitColumns:true,singleSelect:true,fit:true,pagination:true,toolbar:'#toolbar'">
    <thead>
    <tr>
