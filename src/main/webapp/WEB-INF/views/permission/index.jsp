...
<head>
    ...
    <%--引入当前模块对应的js--%>
    <script src="${pageContext.request.contextPath}/js/model/permission.js"></script>
</head>
<body>
...
<table id="datagrid" class="easyui-datagrid"
       data-options="url:'/permission/page',fitColumns:true,singleSelect:true,fit:true,pagination:true,toolbar:'#toolbar'">
    <thead>
    <tr>
...
<div id="editDialog" class="easyui-dialog" title="数据管理"
    ...
    <form id="editForm" method="post">
        ...
        <table cellpadding="5">
            ...
            <tr>
                <td>描述:</td>
                <td><input class="easyui-textbox" multiline="true" name="descs" data-options="required:true"></input></td>
            </tr>
        </table>
    </form>
    <div id="editButtons">
